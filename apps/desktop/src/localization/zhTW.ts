...
export const zhTW = {
  ...
  search: {
    ...
    folderLabel: '此已授權範圍內的資料夾',
    folderAria: '資料夾搜尋篩選條件',
    folderChooseScope: '請先選擇一個已授權範圍，才能依資料夾篩選。',
    allFoldersInScope: '此已授權範圍中的所有資料夾',
    folderLoading: '正在從本機清單載入資料夾…',
    folderEmpty: '這個已授權範圍尚未有建立索引的資料夾。',
    folderPartial: '目前只有受限的本機資料夾清單；需要時請在掃描後縮小範圍。',
    folderError: '無法安全載入資料夾。你仍可繼續搜尋此已授權範圍。',
    folderRetry: '重新載入資料夾清單',
    search: '搜尋',
    searching: '正在搜尋…',
    ...
    filters: {
      ...
      folder: (displayPath) => `資料夾 ${displayPath}`,
      pathsOnly: '僅路徑',
      textOnly: '僅已抽取文字',
