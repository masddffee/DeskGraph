...
| Metadata/FTS/vector/hybrid retrieval           | In progress        | Offline path/content FTS5, bounded queries, deterministic explanations, CLI/Desktop and synthetic 10k p50/p95/index-size baseline pass locally; filters, vectors, embeddings, hybrid fusion, real/100k/8 GB evaluation and cross-platform/live-UI evidence remain |
